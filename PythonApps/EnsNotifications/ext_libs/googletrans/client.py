...
from ext_libs.googletrans import urls, utils
from ext_libs.googletrans.gtoken import TokenAcquirer
from ext_libs.googletrans.constants import (
    DEFAULT_CLIENT_SERVICE_URLS,
    DEFAULT_FALLBACK_SERVICE_URLS,
    DEFAULT_USER_AGENT, LANGCODES, LANGUAGES, SPECIAL_CASES,
    DEFAULT_RAISE_EXCEPTION, DUMMY_DATA
)
from ext_libs.googletrans.models import Translated, Detected, TranslatedPart
